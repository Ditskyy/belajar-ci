...
<main id="main" class="main">
    ...
    <?php 
      // Fitur otomatis membaca URL dari CodeIgniter 4
      $uri = service('uri');
      // Ambil kata pertama setelah slash (misal: produk, keranjang) lalu jadikan huruf besar di awal
      $halaman = $uri->getSegment(1) ? ucfirst($uri->getSegment(1)) : 'Dashboard';
    ?>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body mt-3">
              <h5 class="card-title p-0 mb-3">Data <?= $halaman ?></h5>
